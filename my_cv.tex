...
\cventry{May 2021 -- now}{Google LLC}{Senior Software engineer, Tech Lead}{Proxybidder Team}{}{
	\begin{itemize}
		...
		\item Led effort to optimize bidding behavior for budget restricted customers, which increased spend and bidding quality by \textbf{+3\%}.
		\item Designed and implemented cold start improvements for one of the core bidding algorithms, which serves on \textbf{45\%} of traffic, resulting in \textbf{30\%} of small customers starting to have a traffic. Also, simultameously, the effort ended up being an overall slightly quality positive update, \textbf{+0.3\%}. Due to the nature of the problem, the hardest part was to avoid a quality decrease.
