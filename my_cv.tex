...
\cventry{May 2021 -- now}{Google LLC}{Senior Software engineer, Tech Lead}{Proxybidder Team}{}{
	\begin{itemize}
		...
		\item Led effort to optimize bidding behavior for budget restricted customers, which increased spend and bidding quality by +3\%.
		\item Designed and implemented cold start improvements for one of the core bidding algorithms, which serves on 45\% of traffic, resulting in 30\% of small customers starting to have a traffic and simultameously ended up being an overall slightly quality positive update, +0.3\%. Due to the nature of the problem, the hardest part was to avoid a quality decrease.
		\item Migrated Shopping Bidding solutions on top of central Gooble Bidding stack, fully owning the migration design. One of the strategies which serves \textbf{500 customers} was successfully migrated without any disruptions. Another ongoing initiative involves bidding strategy which is active on 45\% of the Shopping Ads traffic.
	\end{itemize}
}
