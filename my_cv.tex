...
\cventry{May 2018 -- now}{Google Switzerland}{Software engineer}{Google Shopping, Bidding Team}{}{
	\begin{itemize}
		\item Working on cutting edge bidding solutions, which account for significant chunk of Google Shopping revenue.
		\item Understanding Google bidding solusions, reading a lot of source code with no initial knowledge of how they work.
		\item Detected several major bugs in the implementation, fixes of which statistically significantly improved the quality of traffic.
		\item Implemented new bidding strategies and solutions, which did not exist in Google Shopping before.
		\item Working on using Recurrent Neural Networks for session-based optimizations.
	\end{itemize}
}
\cventry{Aug 2017 -- March 2018}{Yandex}{Team Leader, Senior Software Engineer}{Advertising Services, Autobudget Team}{}{
	\begin{itemize}
